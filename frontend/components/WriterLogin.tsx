  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      login(
        ...
        {
          role: 'writer',
          id: writer?.id != null ? String(writer.id) : undefined,
          name: writer?.name,
          phone: writer?.phone,
        },
        { writerPayload: response.data }
      );
        ...
        <div className="text-center mb-8">
          <div className="mx-auto w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mb-4">
            <svg className="w-8 h-8 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" strokeWidth={2} />
            </svg>
          </div>
