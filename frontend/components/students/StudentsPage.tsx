...
import { useStudents, useSaveStudent, useDeleteStudent } from '../../hooks/useStudents';
...
const StudentsPage: React.FC = () => {
    ...
    const saveStudentMutation = useSaveStudent();
    ...
    useEffect(() => {
        if (studentsError || assignmentsError) addToast('Failed to load data', 'error');
    }, [studentsError, assignmentsError, addToast]);
    ...
    const handleSaveStudent = async (studentData: Partial<Student>) => {
        ...
        try {
            const saved = await saveStudentMutation.mutateAsync(studentData as Student);
            setIsFormOpen(false);
            setEditingStudent({});
