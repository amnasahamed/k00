...
const AIAssistant: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // The submit button is gated on `isLoading`, so an unhandled throw
      // here would leave it disabled forever. Catch here to keep the UI
      // responsive and surface a clear error to the user.
