  ...
  try {
    ...
    res.json({
      writer: {
        ...
        phone: writer.phone,
        level: writer.level,
        // Always send the writer's actual points (default 0). Do not alias
        // totalEarnings here — clients use this value to drive gamification
        // (level-up at 100/250/500 pts) and conflating it with revenue
        // makes the metric meaningless.
        points: writer.points || 0,
        rating: avgRating,
